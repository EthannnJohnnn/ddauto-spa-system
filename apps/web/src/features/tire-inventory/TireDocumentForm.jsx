...
export function TireDocumentForm({
  documentType,
  products,
  businessDate,
  editingDocument,
  ...
  useEffect(() => {
    if (editingDocument) {
      ...
      setVehicleDescription(editingDocument.vehicleDescription);
      setPlateNumber(editingDocument.plateNumber);
              ...
              >
                ...
                <div className="mt-3 grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
                  <label className="xl:col-span-2">
                    <FieldLabel>Tire product</FieldLabel>
                    <select
                      className={inputClass}
...
function documentTypeTitle(type) {
  return {
    SALE: 'Record tire sale',
    PURCHASE: 'Record tire purchase',
