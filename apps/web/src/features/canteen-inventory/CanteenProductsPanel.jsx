      ...
      >
        <div className="flex items-start justify-between gap-3">
          <div>
            <p className="text-sm font-semibold text-teal-700">
              {editing ? 'Edit canteen product' : 'New canteen product'}
            </p>
        ...
        <div className="mt-5 space-y-4">
          <TextField
            ...
            placeholder="Example: Wilkins Water"
            required
            value={values.name}
          />
        ...
        <button
          ...
          type="submit"
        >
          {busy ? 'Saving…' : editing ? 'Save product changes' : 'Add canteen product'}
        </button>
      </form>
              ...
              >
                <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
                  <div className="min-w-0">
                    ...
                    <p className="mt-1 text-sm text-slate-500">{categoryLabel(product.category)}</p>
